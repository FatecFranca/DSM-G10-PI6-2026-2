...
const definition = {
  ...
  info: {
    ...
    description: [
      ...
      'decisão**. `confidence` é a probabilidade estimada pelo modelo, aferida no',
      'conjunto de teste, e expressa a frequência observada em perfis semelhantes.',
      'Não determina o desfecho de um estudante específico.',
    ].join('\n'),
  },
