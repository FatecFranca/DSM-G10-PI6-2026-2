...
export const LOCALES = {
  'pt-BR': { label: 'Português (BR)', short: 'PT', messages: ptBR as LocaleTree },
  'en-US': { label: 'English (US)', short: 'EN', messages: enUS as LocaleTree },
  'es-ES': { label: 'Español (ES)', short: 'ES', messages: esES as LocaleTree },
} as const;
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<I18nContextValue>(
    () => ({ locale, setLocale: setLocaleState, t, formatNumber, formatPercent, formatDate }),
    [locale, t, formatNumber, formatPercent, formatDate],
  );
